...
export class AuthComponent implements OnInit {
  ...
  public getRedirectToSpotifyLoginUrl(): string {
    // return 'https://accounts.spotify.com/authorize?response_type=code&client_id=1e72c0f53ed2437e8d9a0ff6a7492811&scope=user-read-private playlist-modify-private playlist-read-collaborative playlist-read-private playlist-modify-public user-modify-playback-state user-library-read&redirect_uri=http://localhost:4200/token'
